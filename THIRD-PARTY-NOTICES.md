...
This static documentation site includes only the runtime assets needed by the generated GitHub Pages output.
...
| Popper.js 1.16.1 | Bootstrap dropdown positioning | MIT |
| highlight.js 9.16.2 | Syntax highlighting | BSD-3-Clause |
| jQuery highlight plugin | In-page text highlighting for article search | MIT |
| FitVids 2.1.1 | Responsive embedded videos | WTFPL |
| Masonry 4.2.2 | Home page category grid layout | MIT |
| repo-card | GitHub repository card on the home page | Unlicense |
| Font Awesome 4.0.3 | Header and navigation icons | Font: SIL OFL 1.1; CSS: MIT |

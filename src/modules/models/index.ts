//import { SFieldDescribe, SObjectDescribe } from "./describeModels";
...
export let CONSTANTS = {
    ...
    COMPLEX_FIELDS_QUERY_SEPARATOR: '_F__COMBI__Q__SEPARA_',

    COMPLEX_FIELDS_QUERY_PREFIX: '_F__COMBI__Q__PREFI_',

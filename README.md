...
*   **Simple and user-friendly configuration** just with a [single .json file]([/full-documentation/configuration-and-running/full-exportjson-format](https://help.sfdmu.com/full-documentation/configuration-and-running/full-exportjson-format))

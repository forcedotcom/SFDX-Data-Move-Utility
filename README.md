...
*   **Simple and user-friendly configuration** just with a single .json file
...
*   Has the **built-in** **data masking feature** to mask a real source data (e.g. coming from Production org).
...
*   **The core functionality can be extended by using the Custom Add-On Api engine**. You can create your own Add-On for your special purposes.

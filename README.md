...
> >  
>
> > **PLEASE, FOLLOW THE BELOW GUIDELINES WHEN OPENING CASES:**
>
> - **We provide <u>ONLY A LIMITED SUPPORT</u> on an free-time basis. Thanks for your understanding!**
> - **We provide support <u>ONLY FOR CRITICAL RUNTIME ERRORS AND FEATURE REQUESTS</u>**. 
>   **For all other problems - please, DO NOT open a case, instead try to resolve the issue using our Documentation and  log files, generated by the Plugin.**
> - **Use only one of our issue tracker templates when submitting cases.**
